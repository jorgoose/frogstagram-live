			...
			<div class="px-3 py-2">
				<div class="relative">
					...
					<input
						type="text"
						placeholder="Search"
						class="w-full rounded-md border-none bg-gray-100 py-2 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800"
					/>
				</div>
			</div>
		...
		<div class="mt-auto border-t border-gray-200 dark:border-gray-800">
			...
			{#if $isMoreMenuOpen}
				<div class="border-b border-gray-200 px-2 py-2 dark:border-gray-800">
					<button
						class="flex w-full items-center rounded-md px-2 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800"
					>
			...
			<!-- Profile Button -->
			<button
				class="flex w-full items-center px-4 py-3 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800"
			>
				<img
					...
					>
						...
						<div class="p-4">
							<div class="mb-2 flex w-full items-center space-x-4">
								<button
									class="rounded-md p-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
								>
							...
							<button class="mt-1 text-sm text-gray-500 hover:underline dark:text-gray-400">
							...
							<div class="mt-2 w-full">
								<input
									...
									class="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 dark:focus:ring-blue-400"
								/>
							</div>
						</div>
					</div>
