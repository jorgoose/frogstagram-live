...
<div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-900">
  <div class="w-full max-w-md">
    <div class="rounded-lg border border-gray-200 bg-white px-8 py-6 shadow-sm dark:border-gray-800 dark:bg-gray-800">
      <!-- Header -->
      ...
      <p class="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <a href="/auth/sign-up" class="font-medium text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300">
          Sign up
        </a>
      </p>
    </div>
