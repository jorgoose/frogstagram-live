...
<div class="flex h-screen bg-white dark:bg-gray-900">
    ...
    <nav class="hidden w-64 flex-shrink-0 flex-col border-r border-gray-200 md:flex dark:border-gray-800">
        ...
        <div class="flex-1">
            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="/explore" class="flex w-full items-center px-6 py-3 text-2xl text-gray-700 hover:bg-green-50 dark:text-gray-200 dark:hover:bg-green-900/20">
                    <Fa icon={faCompass} class="mr-4 h-6 w-6" />
                    <span class="text-sm font-medium">Explore</span>
                </a>

                <a href="/notifications" class="flex w-full items-center px-6 py-3 text-2xl text-gray-700 hover:bg-green-50 dark:text-gray-200 dark:hover:bg-green-900/20">
                    <Fa icon={faFrog} class="mr-4 h-6 w-6 text-green-600 dark:text-green-400" />
                    <span class="text-sm font-medium">Notifications</span>
                </a>

                <a href="/upload" class="flex w-full items-center px-6 py-3 text-2xl text-green-600 hover:bg-green-50 dark:text-green-400 dark:hover:bg-green-900/20">
    ...
    <div class="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900">
        <div class="flex h-full w-full justify-center items-center px-4 pt-20 pb-24 md:pt-8 md:pb-8">
            <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <h2 class="mb-4 text-2xl font-semibold text-center text-green-700 dark:text-green-400">
                    Share a Frog-tastic Photo!
                </h2>
                <p class="mb-4 text-center text-sm text-gray-600 dark:text-gray-300">
                    Only frog-centric images are allowed on Frogstagram. Make sure your photo is froggy enough to hop onto the platform!
                </p>
                <label class="flex flex-col items-center justify-center h-48 border-2 border-dashed border-green-300 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        <Fa icon={faSquarePlus} class="mb-4 h-12 w-12 text-4xl text-green-400 dark:text-green-500" />
                        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                            <span class="font-semibold text-green-600 dark:text-green-400">Tap or select an image</span>
                        </p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Only PNG and JPG are supported</p>
                    </div>
                    <input type="file" accept="image/png, image/jpeg" class="hidden" on:change={handleFileChange} />
                </label>
            </div>
        </div>
    </div>
