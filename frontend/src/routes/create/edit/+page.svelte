...
<div class="flex flex-col h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="flex items-center justify-between p-4 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        ...
        <button 
            ...
            class="text-lg font-medium text-green-600 dark:text-green-400 p-2 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-md active:scale-95 transition-all"
        >
            Next
        </button>
    </div>
        ...
        {#if imageUrl}
            <div class="crop-container">
                ...
                <button 
                    ...
                    class="absolute bottom-4 left-4 z-10 bg-black bg-opacity-50 rounded-full p-2 hover:bg-opacity-70 transition-opacity"
                >
                    <Fa icon={faExpand} class="text-white h-6 w-6" />
                </button>
            </div>
        {:else}
